...
export const pl: Translations = {
  ...
  footer: {
    ...
    discordTitle: 'Dołącz do społeczności',
    discordSubtitle: 'Trening, pytania i społeczność na Discordzie.',
    discordCta: 'Wejdź na Discord',
  },
  home: {
    hero: {
      ...
      stat3Value: 'ES · EN · PL',
      stat3Label: 'Online i stacjonarnie',
    },
  },
  coaching: {
